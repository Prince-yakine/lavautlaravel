...
<!-- Mirrored from codervent.com/dashtrans/demo/vertical/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Mar 2025 10:26:54 GMT -->
<head>
	<!-- Required meta tags -->
	<meta charset="utf-8">
...
<body class="bg-theme bg-theme2">
			...
			<ul class="metismenu" id="menu">
				<li>
					<a href="javascript:;" class="has-arrow">
						...
						<div class="menu-title">LavAut</div>
					</a>
					<ul>
						<li> <a href="index.html"><i class='bx bx-radio-circle'></i>Reservation</a>
						</li>
						<li> <a href="index2.html"><i class='bx bx-radio-circle'></i>Analises</a>
						</li>
					</ul>
				</li>
				<li>
					<a href="javascript:;" class="has-arrow">
						...
						<div class="menu-title">Site Web</div>
					</a>
					<ul>
						<li> <a href="app-Telephone.html"><i class='bx bx-radio-circle'></i>Telephone</a>
						</li>
						<li> <a href="app-Services.html"><i class='bx bx-radio-circle'></i>Services</a>
						</li>
						<li> <a href="app-Prix.html"><i class='bx bx-radio-circle'></i>Prix</a>
						</li>
						<li> <a href="app-aracteristique_services.html"><i class='bx bx-radio-circle'></i>Caracteristique_services</a>
						</li>
						<li> <a href="app-Date de Serviceshtml"><i class='bx bx-radio-circle'></i>Date de Services</a>
						</li>
						<li> <a href="app-Nom.html"><i class='bx bx-radio-circle'></i>Nom</a>
						</li>
						<li> <a href="app-Calendrier.html"><i class='bx bx-radio-circle'></i>Calendrier</a>
						</li>
					</ul>
				</li>
				<li class="menu-label">Éléments de l’interface utilisateur</li>
				<li>
				...
				<nav class="navbar navbar-expand gap-3">
									...
									<div class="header-notifications-list">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												...
												ago</span></h6>
													<p class="msg-info">Successfully created new Telephone</p>
												</div>
											</div>
										</a>
										<a class="dropdown-item" href="javascript:;">
									...
									<div class="header-message-list">
											...
											<div class="d-flex align-items-center gap-3">
												<div class="position-relative">
													<div class="cart-product rounded-circle bg-light">
														<img src="assets/images/Services/11.png" class="" alt="product image">
													</div>
												</div>
												<div class="flex-grow-1">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center gap-3">
												<div class="position-relative">
													<div class="cart-product rounded-circle bg-light">
														<img src="assets/images/Services/02.png" class="" alt="product image">
													</div>
												</div>
												<div class="flex-grow-1">
													<h6 class="cart-product-title mb-0">Men White T-Shirt</h6>
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center gap-3">
												<div class="position-relative">
													<div class="cart-product rounded-circle bg-light">
														<img src="assets/images/Services/03.png" class="" alt="product image">
													</div>
												</div>
												<div class="flex-grow-1">
													<h6 class="cart-product-title mb-0">Men White T-Shirt</h6>
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center gap-3">
												<div class="position-relative">
													<div class="cart-product rounded-circle bg-light">
														<img src="assets/images/Services/04.png" class="" alt="product image">
													</div>
												</div>
												<div class="flex-grow-1">
													<h6 class="cart-product-title mb-0">Men White T-Shirt</h6>
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center gap-3">
												<div class="position-relative">
													<div class="cart-product rounded-circle bg-light">
														<img src="assets/images/Services/05.png" class="" alt="product image">
													</div>
												</div>
												<div class="flex-grow-1">
													<h6 class="cart-product-title mb-0">Men White T-Shirt</h6>
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center gap-3">
												<div class="position-relative">
													<div class="cart-product rounded-circle bg-light">
														<img src="assets/images/Services/06.png" class="" alt="product image">
													</div>
												</div>
												<div class="flex-grow-1">
													<h6 class="cart-product-title mb-0">Men White T-Shirt</h6>
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center gap-3">
												<div class="position-relative">
													<div class="cart-product rounded-circle bg-light">
														<img src="assets/images/Services/07.png" class="" alt="product image">
													</div>
												</div>
												<div class="flex-grow-1">
													<h6 class="cart-product-title mb-0">Men White T-Shirt</h6>
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center gap-3">
												<div class="position-relative">
													<div class="cart-product rounded-circle bg-light">
														<img src="assets/images/Services/08.png" class="" alt="product image">
													</div>
												</div>
												<div class="flex-grow-1">
													<h6 class="cart-product-title mb-0">Men White T-Shirt</h6>
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center gap-3">
												<div class="position-relative">
													<div class="cart-product rounded-circle bg-light">
														<img src="assets/images/Services/09.png" class="" alt="product image">
													</div>
												</div>
												<div class="flex-grow-1">
													<h6 class="cart-product-title mb-0">Men White T-Shirt</h6>
					...
					<div class="user-box dropdown px-3">
						...
						<ul class="dropdown-menu dropdown-menu-end">
							...
							<li><a class="dropdown-item d-flex align-items-center" href="javascript:;"><i class="bx bx-home-circle fs-5"></i><span>LavAut</span></a>
							</li>
						...
						<div class="card radius-10">
							<div class="card-body">
								<div class="d-flex align-items-center">
									...
									<div class="Fenetre-icons ms-auto"><i class='bx bxs-wallet'></i>
									</div>
								</div>
								<div id="chart1"></div>
							</div>
						...
						<div class="card radius-10">
							<div class="card-body">
								<div class="d-flex align-items-center">
									...
									<div class="Fenetre-icons ms-auto"><i class='bx bxs-group'></i>
									</div>
								</div>
								<div id="chart2"></div>
							</div>
						...
						<div class="card radius-10">
							<div class="card-body">
								<div class="d-flex align-items-center">
									...
									<div class="Fenetre-icons ms-auto"><i class='bx bxs-binoculars'></i>
									</div>
								</div>
								<div id="chart3"></div>
							</div>
	...
	<script src="{{ asset('dashboard/plugins/apexcharts-bundle/js/apexcharts.min.js') }}"></script>
